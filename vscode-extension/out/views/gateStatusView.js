...
class GateStatusProvider {
        ...
        try {
            ...
            if (projectId && this.cacheService) {
                ...
                if (cached) {
                    ...
                    this.hasError = false;
                    logger_1.Logger.info('Using cached gates due to network error');
                }
                else {
                    this.gates = [];
                }
    ...
    getRootItems() {
        ...
        if (this.isUsingCachedData) {
            const offlineItem = new GateTreeItem('Offline mode (cached data)', vscode.TreeItemCollapsibleState.None);
