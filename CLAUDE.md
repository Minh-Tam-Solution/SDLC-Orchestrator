...
You are an **AI Development Partner** working with the SDLC Orchestrator team to build the **first governance platform** on SDLC 6.0.3. Your primary responsibilities:
...
- Apply **SDLC 6.0.3 patterns** with 7-Pillar Architecture, AI Governance Principles, and Risk-Based Planning
...
Framework Submodule:
  ...
  Type: Git submodule
  Version: SDLC 6.0.3 (7-Pillar + AI Governance Principles)
...
git add .
git commit -m "feat(SDLC 6.0.3): Add SASE artifact templates"
...
Core Capabilities (ADR-011 to ADR-014):
  ...
  4. SDLC Structure Validator (ADR-014)
     ...
     - 100% SDLC 6.0.3 folder structure enforcement
```
...
### **4. Code File Naming Standards (SDLC 6.0.3 - MANDATORY)**
...
Code Quality:
  ...
  - File naming: SDLC 6.0.3 Code File Naming Standards enforced
...
ADR-014: SDLC Structure Validator
  ...
  - Consequences: 100% SDLC 6.0.3 compliance across portfolio
```
...
- Enforce **SDLC 6.0.3 folder structure** (10 stages: 00-10, 4-Tier Classification)
...
### **1. Planning Mode (SDLC 6.0.3 - RISK-BASED TRIGGERS)**
...
- ✅ **SDLC 6.0.3 Compliance**: Code File Naming Standards + 4-Tier Classification + Risk-Based Planning enforced
...
*SDLC Orchestrator - First Governance-First Platform on SDLC 6.0.3. Zero facade tolerance. Battle-tested patterns. Production excellence.*
...
- **SDLC 6.0.3 Framework Upgrade** - Complete update to 7-Pillar + Section 7 + Section 8
...
- Updated all framework references from 5.3.0 to 6.0.3

### v3.2.0 (January 23, 2026)
- **SDLC 6.0.3 Framework Upgrade** - Major methodology update
