# Onboarding Flow Specification - SDLC 6.1.0
...
This document specifies the complete onboarding flows for SDLC Orchestrator, covering both Web Dashboard and VS Code Extension user journeys. All flows are aligned with SDLC 6.1.0 Contract-First stage structure and 4-Tier Classification system.

### 1.1 Key Changes from SDLC 6.1.0.x

| Aspect | SDLC 6.1.0.x | SDLC 6.1.0 |
|--------|------------|------------|
...
### 1.2 SDLC 6.1.0 Stage Structure (Contract-First Order)
...
```
                    ┌─────────────────────────────────────────────────────────────┐
                    │           SDLC 6.1.0 CONTRACT-FIRST STAGE FLOW              │
...
└─────────────────────────────────────────────────────────────────────────────┘
                                   │
                                   ▼
Step 4: Tier Selection (SDLC 6.1.0)
┌─────────────────────────────────────────────────────────────────────────────┐
│                                                                             │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐        │
...
┌─────────────────────────────────────────────────────────────────────────────┐
│                                                                             │
│  Map existing folders to SDLC 6.1.0 stages:                                 │
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────┐        │
...
│  │  ⭐⭐⭐⭐⭐ (4.8) | 10K+ installs                                  │        │
│  │                                                                  │        │
│  │  Governance-first development with SDLC 6.1.0                    │        │
...
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────┐        │
│  │  🏛️ Create SDLC 6.1.0 Project?                                  │        │
│  │                                                                  │        │
│  │  This folder appears to be empty or doesn't have an             │        │
│  │  SDLC configuration.                                             │        │
│  │                                                                  │        │
│  │  Would you like to initialize an SDLC 6.1.0 compliant           │        │
│  │  project structure?                                              │        │
│  │                                                                  │        │
...
┌─────────────────────────────────────────────────────────────────────────────┐
│                                                                             │
│  Generating SDLC 6.1.0 STANDARD structure...                                │
│                                                                             │
...
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────┐        │
│  │  🎉 SDLC 6.1.0 Project Created!                                 │        │
│  │                                                                  │        │
│  │  Project: my-new-project                                         │        │
│  │  Tier: STANDARD                                                  │        │
│  │  Framework: SDLC 6.1.0 (Contract-First)                          │        │
│  │                                                                  │        │
│  │  Getting Started:                                                │        │
│  │                                                                  │        │
...
| `SDLC: Validate Structure` | Cmd+Shift+V | Validate SDLC 6.1.0 compliance |
...
Scenario: Initialize SDLC project in empty folder
  ...
  Then extension prompts "Create SDLC 6.1.0 Project?"
...
## 4. `.sdlc-config.json` Specification (SDLC 6.1.0)
...
## 6. Migration from SDLC 6.1.0.x

### 6.1 Stage Mapping Changes

| SDLC 6.1.0.x | SDLC 6.1.0 | Change |
|------------|------------|--------|
...
For existing SDLC 6.1.0.x users:
...
```
                    ┌─────────────────────────────────────────────────────────────┐
                    │           SDLC 6.1.0 FOLDER STRUCTURE BY TIER               │
                    └─────────────────────────────────────────────────────────────┘
...
```
                    ┌─────────────────────────────────────────────────────────────┐
                    │              SDLC 6.1.0.x → 5.0.0 MIGRATION PATH               │
                    └─────────────────────────────────────────────────────────────┘


    SDLC 6.1.0.x Structure                    SDLC 6.1.0 Structure
    (BEFORE)                                (AFTER)
    ═══════════════════                     ═══════════════════
    ...
    WHY?
    ─────────────────────────────────────────────────────
    │ SDLC 6.1.0.x: API Design at Stage 07               │
    ...
    ─────────────────────────────────────────────────────
                          ...
                          ▼
    ─────────────────────────────────────────────────────
    │ SDLC 6.1.0: API Design at Stage 03               │
    ...
    │                                                                        │
    │  Planning migration...                                                 │
    │  ✓ Detected SDLC 6.1.0.x structure                                      │
