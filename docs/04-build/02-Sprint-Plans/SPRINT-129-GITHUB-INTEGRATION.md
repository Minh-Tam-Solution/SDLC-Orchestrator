...
Sprint 129 implements **GitHub Project Onboarding**, enabling users to connect their GitHub repositories and run SDLC 6.0.0 gap analysis. This sprint uses a **clone-local strategy** (NOT API fetch) for better performance and user experience.
