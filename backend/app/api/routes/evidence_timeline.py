...
def _build_event_summary(event: AICodeEvent, user: User) -> EvidenceEventSummary:
    ...
    return EvidenceEventSummary(
        ...
        pr_author=user.full_name or user.email or "Unknown",
...
async def request_override(
    ...
    return OverrideRecord(
        ...
        requested_by_name=current_user.full_name or current_user.email or "Unknown",
...
async def approve_override(
    ...
    return OverrideRecord(
        ...
        resolved_by_name=current_user.full_name or current_user.email or "Admin",
...
async def export_timeline(
    ...
    for row in rows:
        ...
        event_data = {
            ...
            "author": user.full_name or user.email or "",
