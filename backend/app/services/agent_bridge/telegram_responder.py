...
_COMMAND_REPLIES: dict[str, str] = {
    ...
    "/help": (
        ...
        "\U0001f916 Agent Direct Routing (Sprint 222)\n"
        "  @<t\u00ean_agent> <tin nh\u1eafn> \u2014 G\u1ecdi tr\u1ef1c ti\u1ebfp EP-07 agent\n"
        "  VD: @pjm b\u00e1o c\u00e1o hi\u1ec7n tr\u1ea1ng d\u1ef1 \u00e1n\n"
        "  VD: @reviewer ki\u1ec3m tra code PR #42\n"
        "  VD: @coder vi\u1ebft unit test cho module auth\n\n"
        "\U0001f539 Workspace\n"
        "  /workspace set <project_id> \u2014 G\u1eafn project v\u00e0o chat n\u00e0y\n"
        "  /workspace status \u2014 Xem workspace hi\u1ec7n t\u1ea1i\n\n"
        "\U0001f539 Governance Commands (g\u1eedi b\u1eb1ng text t\u1ef1 nhi\u00ean)\n"
        "  gate status \u2014 Danh s\u00e1ch quality gates\n"
        "  gate status <gate_id> \u2014 Chi ti\u1ebft gate\n"
        "  approve gate <gate_id> \u2014 Duy\u1ec7t gate\n"
        "  reject gate <gate_id> \u2014 T\u1eeb ch\u1ed1i gate\n"
        "  submit evidence \u2014 N\u1ed9p evidence cho gate\n"
        "  update sprint \u2014 C\u1eadp nh\u1eadt sprint hi\u1ec7n t\u1ea1i\n"
        "  close sprint \u2014 \u0110\u00f3ng sprint\n"
        "  export audit \u2014 Xu\u1ea5t audit log\n"
        "  invite member <email> \u2014 M\u1eddi th\u00e0nh vi\u00ean\n\n"
        "\U0001f539 Multi-Agent Team (Sprints 218\u2013222)\n"
        "  @vote create \u201ct\u00ean\u201d majority|unanimous \u2014 T\u1ea1o phi\u1ebfu b\u1ea7u\n"
        "  @vote approve \u201cl\u00fd do\u201d \u2014 B\u1ecf phi\u1ebfu \u0111\u1ed3ng \u00fd\n"
        "  @vote reject \u201cl\u00fd do\u201d \u2014 B\u1ecf phi\u1ebfu ph\u1ea3n \u0111\u1ed1i\n\n"
        "\U0001f539 General\n"
    ...
    "/status": (
        ...
        "\u2705 EP-07 Multi-Agent: Active\n"
        "\U0001f4ca Framework: SDLC 6.1.1\n"
        "\U0001f4cc Version: v2.0 (Sprint 222)\n\n"
        "G\u1eedi /help \u0111\u1ec3 xem c\u00e1c l\u1ec7nh governance v\u00e0 @agent routing."
    ),
