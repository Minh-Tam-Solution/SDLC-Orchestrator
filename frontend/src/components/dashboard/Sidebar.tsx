/**
 * Dashboard Sidebar - SDLC Orchestrator
 *
 * @module frontend/src/components/dashboard/Sidebar
 * @description Main navigation sidebar for dashboard
...
const navigationItems = [
  ...
  // Sprint 153: Notifications (Real-time Notifications)
  {
    name: "Notifications",
  ...
  // Sprint 152: Context Authority (SSOT Dashboard)
  {
    ...
    href: "/app/context-authority",
    icon: LayersIcon,
  },
  // Sprint 151: VCR (SASE Artifacts)
  {
    name: "VCR",
    href: "/app/vcr",
    icon: DocumentCheckIcon,
  },
  // Sprint 151: CRP (SASE Artifacts - Consultation Request Protocol)
  {
    name: "CRP",
    href: "/app/crp",
    icon: ChatBubbleIcon,
  },
  // Sprint 152: MRP (Merge Readiness Protocol)
  {
    name: "MRP",
    href: "/app/mrp",
    icon: MergeReadinessIcon,
  },
  // Sprint 151: SASE Templates
  {
    name: "SASE Templates",
    href: "/app/sase-templates",
    icon: TemplateIcon,
  },
  ...
  // Sprint 85: CLI Tokens (CLI Authentication)
  {
    name: "CLI Tokens",
    href: "/app/cli-tokens",
    icon: KeyIcon,
  },
  // Sprint 86: GitHub Check Runs (P0 Blocker)
  {
    name: "Check Runs",
    href: "/app/check-runs",
    icon: CheckBadgeIcon,
  },
  // Sprint 87: Evidence Manifests (P0 Blocker - Hash Chain v1)
  {
    name: "Hash Chain",
    href: "/app/evidence-manifests",
    icon: LinkIcon,
  },
  {
    name: "App Builder",
...
// Sprint 153: Notifications icon (bell)
...
// Sprint 151: VCR icon (document with check)
...
// Sprint 151: CRP icon (chat bubble for consultation)
...
// Sprint 152: MRP icon (merge readiness - 5 checkpoints)
function MergeReadinessIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
// Sprint 154: Spec Converter icon (file-code with arrows)
function SpecConverterIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
// Sprint 84: Teams icon (user group)
...
// Sprint 84: Organizations icon (building office)
...
// Sprint 86: Check Runs icon (check badge)
...
// Sprint 87: Hash Chain icon (link)
...
// Sprint 151: SASE Templates icon (document stack)
...
// Sprint 152: Context Authority icon (layers/stacked panels)
...
// Sprint 175: CEO Dashboard icon (chart bar)
...
// Sprint 175: Planning icon (calendar days)
...
// Sprint 175: Plan Review icon (clipboard with check)
...
// Sprint 175: Learnings icon (academic cap)
      ...
      <div className="flex h-16 items-center justify-between border-b border-gray-200 px-4">
        {!isCollapsed && (
          <Link href="/app" className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-gray-900">SDLC</span>
          </Link>
        )}
        <button
