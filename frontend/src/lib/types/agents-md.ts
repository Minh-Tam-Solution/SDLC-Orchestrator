...
/**
 * Analytics summary combining all metrics
 */
...
export interface AgentsMdMetrics {
  ...
  regenerations_this_period: number;
}
...
export interface ProjectAnalytics {
  ...
  context_overlays: {
    total: number;
    by_trigger: Record<TriggerType, number>;
